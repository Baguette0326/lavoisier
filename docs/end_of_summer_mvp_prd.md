...
The strongest portfolio claim is not “AI found the best material.” It is “I built a transparent screening workflow that makes heterogeneous evidence safer and faster to review.”
...
1. The user opens CarbonSense and loads the bundled approved demonstration dataset or uploads a compatible CSV.
2. CarbonSense validates required fields, units, evidence labels, and condition metadata. Blocking errors stop ranking; non-blocking gaps produce warnings.
3. The user selects one capture context and a comparable subset of records.
4. The user chooses available criteria and adjusts their weights. CarbonSense shows the scoring direction and normalizes active weights.
5. CarbonSense ranks the subset and displays each candidate’s score, component contributions, provenance, evidence type, missing-data warnings, and engineering tradeoff flags.
...
- declaring a universally “best” adsorbent;
...
### M1 — Freeze the comparison contract
...
### M2 — Integrate one approved dataset
...
### M3 — Complete the screening loop
...
1. **Frame the problem (30 seconds):** “Adsorbent datasets contain promising numbers measured or predicted under different conditions. CarbonSense helps create a reviewable shortlist without pretending those numbers are universally comparable.”
...
8. **Close (15 seconds):** “The output is a reproducible screening decision for further review, not a claim that the top-ranked material is experimentally or economically best.”
